...
'
    ...
    Function Invoke-Action {
        ...
        if ( $Window -contains 'Hidden' ) { $processArgumentsAdd('WindowStyle' , 'Hidden') }
        if ( $Window -contains 'Normal' ) { $processArgumentsAdd('WindowStyle' , 'Normal') }
        if ( $Window -contains 'Maximized' ) { $processArgumentsAdd('WindowStyle' , 'Maximized') }
